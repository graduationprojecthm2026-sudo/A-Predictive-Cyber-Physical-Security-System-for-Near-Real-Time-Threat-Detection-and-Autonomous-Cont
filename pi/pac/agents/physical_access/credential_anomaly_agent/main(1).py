...
AGENT_ID    = os.getenv("AGENT_ID",          "credential-anomaly-agent-01")
...
class CredentialAnomalyAgent:
    def __init__(self):
        ...
        self._stats = {"processed": 0, "alerts": 0,
                       ...
                       "off_schedule": 0, "heartbeats_sent": 0}
    ...
    def handle_event(self, topic: str, payload: dict):
        ...
        hour     = int(payload.get("hour", datetime.now(TZ_LOCAL).hour))
        ts       = time.time()
    ...
    def start(self):
        ...
        threading.Thread(target=self._heartbeat_loop,
                         daemon=True, name="cred-anomaly-heartbeat").start()
